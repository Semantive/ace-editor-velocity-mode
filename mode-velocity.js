// Author: Maciej Górnicki (Semantive)
ace.define('ace/mode/velocity', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/mode/javascript', 'ace/tokenizer', 'ace/mode/java_highlight_rules'], function (require, exports, module) {
...
ace.define('ace/mode/java_highlight_rules', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], function (require, exports, module) {
    ...
    var JavaHighlightRules = function () {
        var keywords = (
            "set|foreach|end|if|else|elseif|" +
                "parse|macro|stop|include" +
                "eq|ne|gt|lt|ge|le|not|" +
                "in|" +
                "break|evaluate|define"
            );
